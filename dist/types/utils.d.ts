...
export declare function preprocessVertShader(shaderSource: string, glslVersion: GLSLVersion, verboseLogging: boolean): string;
export declare function preprocessFragShader(shaderSource: string, glslVersion: GLSLVersion, verboseLogging: boolean): string;
