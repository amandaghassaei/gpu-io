...
export declare function insertHeader(glslVersion: GLSLVersion, intPrecision: GLSLPrecision, floatPrecision: GLSLPrecision, shaderSource: string, defines?: CompileTimeVars): string;
