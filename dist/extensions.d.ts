...
export declare function getExtension(gl: WebGLRenderingContext | WebGL2RenderingContext, extensionName: string, errorCallback: (message: string) => void, optional?: boolean): any;
