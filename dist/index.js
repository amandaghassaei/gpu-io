...
var WebGLCompute = /** @class */ (function () {
    ...
    ;
    WebGLCompute.prototype.setPositionAttribute = function (program) {
        this.setVertexAttribute(program, 'a_internal_position', 2);
    };
    WebGLCompute.prototype.setIndexAttribute = function (program) {
        this.setVertexAttribute(program, 'a_internal_index', 1);
    };
    WebGLCompute.prototype.setUVAttribute = function (program) {
        this.setVertexAttribute(program, 'a_internal_uv', 2);
    };
    WebGLCompute.prototype.setVertexAttribute = function (program, name, size) {
        var gl = this.gl;
